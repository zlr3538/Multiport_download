...
#if defined(__GNUC__)
int __stdcall Brom_ConnectByPath(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, char*  dev_path, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type = CONNECT_METHOD_NONE, bool enable_connect_without_battery = false);
#endif
#if defined(_WIN32)
int __stdcall Brom_Connect(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, unsigned char  com_port, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type = CONNECT_METHOD_NONE, bool enable_connect_without_battery = false);
#elif defined(__GNUC__)
int __stdcall Brom_Connect(unsigned int *p_brom_handle, FLASHTOOL_API_HANDLE_T  *p_ft_handle, char*  com_port, BBCHIP_TYPE  bbchip_type, EXT_CLOCK  ext_clock, int *p_bootstop, unsigned int ms_boot_timeout, unsigned int max_start_cmd_retry_count, CONNECT_METHOD com_type = CONNECT_METHOD_NONE, bool enable_connect_without_battery = false);
#endif
